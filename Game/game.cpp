...
unsigned char *Game::copyData(unsigned char *originData,int width,int height) {
    vector<vector<unsigned char>> *oneDemensionAndGray= this->oneDemensionAndGray(width,height,originData);
...
unsigned char *Game::findCannySobel(unsigned char *data, int width, int height) {
